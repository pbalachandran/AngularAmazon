...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `amazon` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `account` VALUES ('pbalachandran','Pradeep','Balachandran','amazon',1),('rchandrasekaran','Renuka','Chandrasekaran','amazon',2);
...
INSERT INTO `category` VALUES (1,'Electronics'),(2,'Furniture'),(3,'Home Appliances');
...
CREATE TABLE `creditcard` (
  ...
  KEY `creditcardtypeFK_idx` (`creditcardtypename`),
  CONSTRAINT `creditcardtypeFK` FOREIGN KEY (`creditcardtypename`) REFERENCES `creditcardtype` (`creditcardtypename`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `creditcard` VALUES (1,'171927173772615','Discover','Pradeep','Balachandran','01/17','234'),(2,'9818191938828','VISA','Renuka','Chandrasekaran','12/20','767');
...
CREATE TABLE `creditcardtype` (
  `creditcardtypename` varchar(45) NOT NULL,
  PRIMARY KEY (`creditcardtypename`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `creditcardtype` VALUES ('Discover'),('MasterCard'),('VISA');
...
INSERT INTO `inventoryitem` VALUES (19,'Computer Table & Chair','Computer Table & Straightback Chair',1099.99,99,2),(20,'Electric Kettle','Krups Electric Kettle',105.99,10,3),(21,'Leather Chair','Top Grain Leather Chair',299.99,4,2),(22,'Rocking Chair','Oak Rocking Chair',299.99,10,2),(23,'Coffee Maker','Krupps Coffee Maker',50.99,10,3),(24,'iPhone7','Apple iPhone7 8Gb',500.99,100,1),(25,'iPad','Apple iPad 8Gb',400.99,100,1),(26,'Oster Blender','Oster Blender',105.99,10,3);
...
INSERT INTO `invoice` VALUES (1,1399.98,112,1511.98,'CHARGE:Discover-174163','2016-03-10',1),(2,299.99,24,323.99,'CHARGE:Discover-284120','2016-03-10',2),(3,299.99,24,323.99,'CHARGE:Discover-557249','2016-03-10',1),(4,599.98,48,647.98,'CHARGE:Discover-394085','2016-03-10',3),(5,299.99,24,323.99,'CHARGE:Discover-137020','2016-03-10',4);
...
INSERT INTO `orderitem` VALUES (1,21,1,1),(2,19,1,1),(3,21,1,2),(4,21,1,3),(5,21,2,4),(6,21,1,5);
...
INSERT INTO `shippinginfo` VALUES (1,'Pradeep','Balachandran','4117 Silverwood Lane','Bedford','TX','76021'),(2,'Pradeep','Balachandran','4117 Silverwood Lane','Bedford','TX','76021'),(3,'Pradeep','Balachandran','4117 Silverwood Lane','Bedford','TX','76021'),(4,'Pradeep','Balachandran','4117 Silverwood Lane','Bedford','TX','76021');
...
INSERT INTO `shoppingcart` VALUES (1,1399.98,1,'pbalachandran','complete'),(2,299.99,2,'pbalachandran','complete'),(3,299.99,3,'pbalachandran','complete'),(4,599.98,4,'pbalachandran','complete'),(5,299.99,5,'pbalachandran','complete');
...
-- Dump completed on 2016-03-11 17:29:01
